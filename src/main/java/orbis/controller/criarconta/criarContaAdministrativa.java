 ...
 */
@WebServlet(name = "/CriarContaAdministrativa", urlPatterns = {"/CriarContaAdministrativa"})
public class criarContaAdministrativa extends HttpServlet {
